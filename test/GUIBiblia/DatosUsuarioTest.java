...
/**
 * El constructor de DatosUsuario carga la tabla desde la base de datos
...
public class DatosUsuarioTest {
    ...
    public void seConstruyeSinLanzarExcepciones() throws Exception {
        ventana = VentanaTestUtils.crearEnEdt(DatosUsuario::new);
    ...
    @Test(timeout = TIMEOUT_MS)
    public void laTablaDeUsuariosTieneLasNueveColumnasEsperadas() throws Exception {
        ventana = VentanaTestUtils.crearEnEdt(DatosUsuario::new);
